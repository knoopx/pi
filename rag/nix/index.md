...
## [Functional package language](#functional-package-language)
...
## [Transparent source/binary deployment](#transparent-sourcebinary-deployment)
...
`/nix/store/b6gvzjyb2pg0kjfwrjmg1vfhh54ad73z-firefox-33.1` from source, Nix would first
...
## [Nix Packages collection](#nix-packages-collection)
...
## [Managing build environments](#managing-build-environments)
