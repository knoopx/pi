...
[Introduction](/docs/ai-gateway/introduction)[Getting Started](/docs/ai-gateway/getting-started)[Universal API](/docs/ai-gateway/universal-api)
...
[Edit this page](https://github.com/zuplo/docs/edit/main/docs/ai-gateway/introduction.mdx)
...
- [Key Benefits](/docs/ai-gateway/introduction#key-benefits)
- [How It Works](/docs/ai-gateway/introduction#how-it-works)
- [Core Features](/docs/ai-gateway/introduction#core-features)
  - [Multi-Provider Support](/docs/ai-gateway/introduction#multi-provider-support)
  - [Team Hierarchy & Budgets](/docs/ai-gateway/introduction#team-hierarchy--budgets)
  - [Application Configuration](/docs/ai-gateway/introduction#application-configuration)
- [Use Cases](/docs/ai-gateway/introduction#use-cases)
