...
> **Tip**
>
> These pages are written as a reference. If you are learning Nix, nix.dev has a good [introduction to the Nix language](https://nix.dev/tutorials/nix-language).
...
| Example                                                                         | Description                                                                                                                                                                                                                                                  |
| ------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| *Basic values ([primitives](/manual/nix/2.28/language/types#primitives))*       |                                                                                                                                                                                                                                                              |
...
| *[Functions](/manual/nix/2.28/language/syntax#functions) (lambdas)*             |                                                                                                                                                                                                                                                              |
