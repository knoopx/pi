...
The [AI SDK](https://ai-sdk.dev/) is a free open-source library that gives you the tools you need to build AI-powered products.

## Prerequisites

use the AI Gateway with any AI SDK powered application you will need to complete these steps first:
