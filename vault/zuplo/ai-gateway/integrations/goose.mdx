...
[goose](https://block.github.io/goose/) is an local AI agent and CLI tool for automating engineering tasks.

## Prerequisites

use the AI Gateway with goose you will need to complete these steps first:
...
set up the provider in the Prerequisites step (for example gpt-4o, gpt-5, gpt-5-nano)

10. Click on **Create Provider**

</Stepper>

The Zuplo AI Gateway and associated provider and models will now be available to use with the goose desktop application.
