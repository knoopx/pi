...
Zuplo's AI Gateway supports the addition of custom AI providers.

:::note

currently only OpenAI-compatible models are supported using custom providers
...
along with their type. Optionally, you can add a dollar cost for input and output tokens if you wish to track this via the AI Gateway.
...
Further information can be found in the [Managing Providers](./managing-providers.mdx) guide.
