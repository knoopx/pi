...
The Galileo Tracing policy integrates [Galileo AI](https://www.galileo.ai/) with the Zuplo AI Gateway, providing comprehensive observability, monitoring, and evaluation of your LLM applications.
...
You can add the policy to any AI Gateway app by clicking on **Policies**, then on **Add Policy** and select **Galileo Tracing**.

![The AI Gateway policy picker](/media/galileo-tracing/galileo-tracing-1.png)

3.  ### Configure the policy

You will need to enter the following information from your Galileo account to configure the policy:
...
The `projectId` and `logStreamId` are both found in the URL of the Galileo log stream you want to use.
