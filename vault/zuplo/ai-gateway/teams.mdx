...
Teams are used to manage access to AI Gateway applications, set usage limits, and monitor activity.
...
For more information on roles and permissions, see the [document on roles and permissions](../articles/accounts/roles-and-permissions.mdx).
