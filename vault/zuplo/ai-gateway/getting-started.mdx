...
Providers are the LLM services (like OpenAI or Google Gemini) that your applications will use.
...
Teams allow you to organize users and set hierarchical budget controls.
...
Applications represent individual projects or services that will use the AI Gateway.
...
In the examples below, we assume that you are using the official [Node.js OpenAI SDK](https://platform.openai.com/docs/libraries/node-js-library) and that you have executed `npm install openai`.
