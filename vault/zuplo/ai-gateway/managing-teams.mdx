...
Teams in the Zuplo AI Gateway are how users are granted access to AI Providers and Apps.
...
member of your Zuplo account they will be directly added to the team. If they don't have an account, they will be invited to join the account and then added to the team.
...
RBAC is an optional enterprise add-on. For more information see the [document on roles and permissions](../../articles/accounts/roles-and-permissions.mdx).
