...
We're announcing the end of life for Zuplo's v1 monetization product.
...
After careful consideration and extensive customer feedback, we've decided to sunset our v1 monetization product for the following reasons:
...
We believe in doing one thing exceptionally well. Zuplo's strength lies in building the most powerful, developer-friendly API management platform.

## Our New Approach: Best of Both Worlds

Instead of building monetization features from scratch, we're partnering with best-in-class monetization platforms and creating deep integrations, guides, and samples.
...
We're committed to supporting our existing monetization customers through this transition:
...
Choose the monetization platform that best fits your needs, whether it's Amberflo, Moesif, Polar, tripe Billing, or another solution.
...
assistance with migration, please reach out to our support team at support@zuplo.com.

## Conclusion

This change represents our commitment to providing you with the best possible tools for API management and monetization.

We're excited about this new direction and the possibilities it opens up for your API monetization strategies.
