...
Zuplo supports multifactor authentication (MFA) to help keep your account secure.
...
To disable multifactor authentication for your account, navigate to the **Multifactor Authentication** section of your user profile and click **Disable** next to the multifactor authentication method you want to remove.

## Enforcing Multifactor Authentication for Tenant Members

If you have MFA enabled and you are an admin of a tenant account, you can enforce all members of that account to use multifactor authentication.
