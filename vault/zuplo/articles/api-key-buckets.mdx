...
API keys are stored in "buckets," which organize and isolate authentication credentials across different environments.
...
For more information on how environments relate to Git branches, see [Branch-Based Deployments](./branch-based-deployments.mdx).
...
Create custom buckets using the [API Key management API](https://dev.zuplo.com/docs).
