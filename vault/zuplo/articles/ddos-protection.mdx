...
<!-- vale Vale.Spelling["slowloris","Unmetered"] = NO -->

Zuplo provides automatic DDoS (Distributed Denial of Service) protection for all APIs deployed on the platform.

:::note

Zuplo Managed DDoS is only available for customers using Zuplo's managed edge deployment model.

:::

## What's DDoS?

DDoS attacks attempt to overwhelm your API by flooding it with malicious traffic from multiple sources.
...
All Working Copy environments (`.zuplo.dev` domains) are automatically protected with **Medium** sensitivity.
...
Zuplo's DDoS protection uses sophisticated algorithms to analyze traffic patterns in real-time.
