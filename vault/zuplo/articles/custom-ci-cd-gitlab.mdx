...
GitLab CI/CD provides integrated pipelines right where your code lives.

## Why GitLab CI/CD with Zuplo?

The Zuplo CLI works seamlessly with GitLab's pipeline model:

**Everything in one place** — Source code, CI/CD, environments, and deployments all in GitLab.
...
**Artifacts between jobs** — Pass deployment URLs between stages using GitLab artifacts.
...
**Settings** > **CI/CD** > **Variables** and add `ZUPLO_API_KEY`. Check **Mask variable** to hide it in logs.
