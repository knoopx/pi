...
Connect your Zuplo project to GitHub for source control and automatic deployments.

## Connect Your Project to GitHub

This guide assumes you have a Zuplo project created. If you don't have one yet, follow the steps in [Step 1 - Setup a Basic Gateway](./step-1-setup-basic-gateway.mdx) to create a new Zuplo project.

<Stepper>

1. Connect to GitHub

Go to your project in the Zuplo portal and open to the **Settings** tab, then select **Source Control**.

![Connect GitHub](../../public/media/step-4-deploying-to-the-edge/image-1.png)

1. **Authorize Zuplo**

A dialog will open asking you to authorize Zuplo. Click the **Authorize Zuplo** button.
...
With your GitHub App configured, return to the Zuplo portal. In the **Source Control** settings you should now see a list of GitHub repositories.
...
Click the link to return to GitHub. You should see a green check next to the commit hash (1).
...
If you have an existing GitHub repository that contains a Zuplo project, you can connect to that repository when you create a new project.
