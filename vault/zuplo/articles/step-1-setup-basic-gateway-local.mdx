...
The [create-zuplo-api](../cli/create-zuplo-api.mdx) tool supports creating projects from templates.
...
create your first route. You can open the Route Designer by clicking the link in the terminal after you run `npm run dev`.
...
**Save your changes** - click **Save** at in the bottom left, or press **CMD+S**
...
using the [Zuplo CLI](../cli/overview.mdx). When you run this command, you will be prompted to login if you haven't already.

If you haven't already created a Zuplo project, you will be prompted to do so.
...
**NEXT** Try [Step 2 - Add Rate Limiting to your API](./step-2-add-rate-limiting-local.mdx).
