...
In Zuplo's managed edge environment, HTTP connections have timeouts to ensure efficient use of resources.
...
Zuplo doesn't impose a hard cap on the number of consumers or keys you can create.
...
The [cache API](../programmable-api/cache.mdx) and abstractions on top of it such as [ZoneCache](../programmable-api/zone-cache.mdx) have the following limits:
