...
This plugin pushes request/response data to Akamai API Security, formerly known as "NONAME" API Security.

<EnterpriseFeature name="Custom logging" />

## Setup

To get started, you'll need to configure the Zuplo Integration in Akamai API Security.

In Zuplo you configure the plugin in the [Runtime Extensions](../programmable-api/runtime-extensions.mdx) file `zuplo.runtime.ts`, as follows:
...
It's recommended to store your key in an [Environment Variable](./environment-variables.mdx) shown in the example above `AKAMAI_API_SECURITY_KEY`.
