...
This document explains the Zuplo support plans, communication methods, severities, and response times provided by Zuplo support.
...
features, or solution configurations for the particular type of reporting, analysis, or functionality.
...
submit change or enhancement requests, and provide fixes for the Zuplo platform as necessary.
...
Customers with Zuplo's free subscription plan can seek support through the Zuplo Community.
...
Enterprise support contracts can optionally chat directly with the Zuplo team in a private Discord or Slack channel.

:::caution

Private channels shouldn't be used for urgent/business critical support requests as the team may not be immediately notified.

:::

### Emergency Phone Support

Customers with emergency phone support can call +1 833-681-6018 to open an emergency support ticket.
