...
**Powerful workflows** — Fan-out/fan-in patterns, conditional jobs, and manual approval gates.

**Workspaces and caching** — Share files between jobs efficiently. Cache dependencies for faster builds.

**Reusable configuration** — Create orbs to share deployment patterns across projects.

**Parallelism and performance** — Run tests in parallel. Split by timing data for optimal speed.
...
disconnect the native Git integration to avoid duplicate deployments. Go to **Settings** > **Source Control** and click **Disconnect**.
