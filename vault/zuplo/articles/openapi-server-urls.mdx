...
Zuplo automatically overwrites the server URLs in your OpenAPI specification files with the URL of the current environment.
...
If you need to use a [custom domain](./custom-domains.mdx) instead of the default Zuplo URL, you can configure one on a per-environment basis.
