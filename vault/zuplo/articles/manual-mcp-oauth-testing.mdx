...
The following guide walks you through manually testing an OAuth provider with a client ID and secret configuration.
...
This script does **not** include a web server and does **not** support dynamically extracting the authorization callback code.
