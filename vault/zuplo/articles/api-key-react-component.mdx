...
See our blog for an [end to end tutorial](https://zuplo.com/blog/2023/08/08/open-source-release) on using this React component and the translation API.
...
Import the component's stylesheet into your `global.css` or equivalent file.
...
The API Key Manager component interacts with an API that allows authorized users to manage their own keys.
