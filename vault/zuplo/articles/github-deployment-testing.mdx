...
Run your test suite automatically after every Zuplo deployment without replacing the built-in GitHub integration.

## Why This Approach?

Zuplo's GitHub integration already handles deployments perfectly — every push deploys automatically with status checks in GitHub.
