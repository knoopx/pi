...
Features describe what your API offers to customers.
...
Features cannot be updated after creation - they can only be archived.
...
For complete API operations (list, get, archive), see the [Features API Reference](../../api/metering-features).
