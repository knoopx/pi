...
Pricing models define how charges are calculated within a [rate card](./rate-cards.mdx).
...
Per-unit pricing charges a fixed amount for each unit of metered usage.
...
See [Plan Examples](./plan-examples.mdx) for step-by-step examples showing how to build plans with different pricing models.
