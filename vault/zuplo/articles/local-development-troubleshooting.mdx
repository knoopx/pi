...
By default the Zuplo local server runs on port 9000 and route designer runs on port 9100.
...
When running Zuplo locally you may want to call a service with a self-signed certificate.
...
Please reach out to support@zuplo.com or join our [Discord server](https://discord.gg/8QbEjr2MgZ).
