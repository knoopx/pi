...
In this custom inbound policy we show how you could post to a service (in this case we use RequestBin.com).
...
You can create a free Mockbin at [mockbin.io](https://mockbin.io) - to get started quickly look for the link to create a new bin (not OpenAPI bin).
