...
Your browser will open and prompt you to log in to your Zuplo account.

## Using an API key

API key authentication is useful for CI/CD pipelines or other automated workflows where interactive login isn't feasible.

:::tip

The API key is scoped to your account. So you can use the same one for all projects under the same account.
