...
By default, users who log into your Zuplo powered Developer Portal won't have an API Consumer.
...
Before you begin, you will need to [setup custom authentication](./zudoku/configuration/authentication.mdx) for the developer portal - you can't use the built-in "demo" provider for this tutorial.

To begin, open the [Auth0 management portal](https://manage.auth0.com) and navigate to **Actions** > **Library**.
...
Next, add the Node module [`undici`](https://www.npmjs.com/package/undici) as a package to the custom action.

![Add dependency](../../public/media/dev-portal-create-consumer-on-auth/0daf1916-3fac-4bed-b00d-55694236619c.png)

authenticate to Zuplo's Developer API, you will need to get your API Key.

![Define a secret](../../public/media/dev-portal-create-consumer-on-auth/2cf32602-9716-4b8d-9641-3830500e01c1.png)

:::info

In the code below set the variable `BUCKET_NAME` to the bucket being used by your Zuplo Gateway.

:::

Next, add the following code to your custom action. Be sure to replace the placeholder values with your actual account and bucket names.
...
Last, on the Auth0 side navigation bar, open **Actions** > **Flows**, then select **Login**.
