...
The URL Forward handler proxies requests to a different API without writing any code.

:::tip

Type-Safe Configuration Use TypeScript for enhanced development experience with full type checking and IntelliSense support when configuring handlers.
