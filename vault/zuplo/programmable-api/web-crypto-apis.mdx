...
The runtime implements all operations of the [WebCrypto standard](https://www.w3.org/TR/WebCryptoAPI/), as shown in the following table.
...
[^2]: Legacy non-standard EdDSA is supported for the Ed25519 curve in addition to the Secure Curves version.
...
guarantee it at this time, Cloudflare will strive to maintain backward compatibility and compatibility with NodeJS's behavior.

[^3]: MD5 isn't part of the WebCrypto standard but is supported in Cloudflare Workers for interacting with legacy systems that require MD5.
