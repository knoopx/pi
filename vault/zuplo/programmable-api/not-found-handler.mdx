...
By default, Zuplo will return a 404 (using [problem details](./http-problems)) if no matching `path/method` combination is found.
...
An error in your `zuplo.runtime.ts` can break your gateway for all requests.
