...
The `StreamingZoneCache` class provides a distributed caching solution optimized for streaming data.

:::note{title="Beta Feature"}

This API is in Beta - please use with care and provide feedback to the team if you encounter any issues.
