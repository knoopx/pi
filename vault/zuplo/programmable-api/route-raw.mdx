...
Each route in your OpenAPI file allows for specifying custom properties on your route that can be referenced in code.
...
Custom data can be accessed through the `context.route.raw()` function.
