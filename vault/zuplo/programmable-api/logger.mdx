...
The `Logger` interface provides structured logging capabilities throughout your Zuplo API gateway.
...
Logs are automatically forwarded to your configured log management solution (Datadog, Loki, etc.).
