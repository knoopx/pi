...
The BackgroundLoader class provides asynchronous loading of configuration data while minimizing gateway latency.
...
You can't return a `Response` created by the BackgroundLoader as a response from a policy or handler.
