...
Zuplo maintains a variety of sample APIs that are all built with Zuplo.

## Echo API

The echo API will accept any request and will return a JSON object with details of that request.
...
This is similar to the E-Commerce API but with a different URL structure.
