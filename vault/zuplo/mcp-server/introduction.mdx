...
used via a simple [JSON-RPC 2.0](https://www.jsonrpc.org/specification) message flow.
...
- [MCP Tools Documentation](./tools)
- [MCP Prompts Documentation](./prompts)
- [MCP Resources Documentation](./resources)
- [MCP Custom Tools Documentation](./custom-tools)
