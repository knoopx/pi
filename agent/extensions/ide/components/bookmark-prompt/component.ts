...
import { fuzzySort } from "../../../../shared/matching/fuzzy";
...
export function createBookmarkPromptComponent(
  ...
  return new BookmarkPrompt(options);
}
...
class BookmarkPrompt implements Component {
  ...
  constructor(private options: BookmarkPromptOptions) {
  ...
  getCandidates(): string[] {
    ...
    const filtered = filterBookmarkCandidates(this.bookmarks, query);
