...
Enable automatic JJ hooks for change management:

```
/jujutsu-enable-hooks
```

#### Disable Hooks

Disable automatic JJ hooks for change management:

```
/jujutsu-disable-hooks
```

Useful when you want to manually control JJ changes without automatic creation.
